...
import com.ssm.chapter9.lifecycle.TestSpringBeanLifecycleBean;
...
//		testIoC();
	...
	private static void testBeanLifecycle() {
		...
		TestSpringBeanLifecycleBean lifecycleBean = (TestSpringBeanLifecycleBean) ctx.getBean("testSpringBeanLifecycleBean");
